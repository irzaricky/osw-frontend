...
export const WO_STATUS_COLOR: Record<
  WorkOrderStatus,
  ...
  const columns: ColumnDef<WorkOrder>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) =>
        h(
          ...
          {
            class:
              "font-semibold text-primary hover:underline text-left font-mono",
    ...
    },
    {
      ...
      cell: ({ row }) =>
        h(
          ...
          row.original.production_order?.po_number ?? "-"
        ),
    },
    {
      id: "part",
      ...
      cell: ({ row }) =>
        h("div", [
          h(
            ...
            row.original.part?.part_name ?? "-"
          ),
          h(
            "div",
            { class: "text-xs text-muted font-mono" },
            row.original.part?.part_number ?? ""
          ),
        ]),
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const actual = row.original.actual_quantity;
        ...
        return h("div", { class: "font-mono text-sm" }, [
          ...
          h(
            ...
            {
              class:
                actual >= planned ? "text-success-600" : "text-warning-600",
            },
                ...
                [
                  {
                    label: "Start WO",
                    icon: "i-lucide-play",
                    onSelect: () => actions.onStart(row.original),
