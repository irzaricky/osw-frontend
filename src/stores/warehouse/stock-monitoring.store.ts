...
import { ref } from 'vue'
import stockMonitoringService from '../../services/warehouse/stock-monitoring.service'
import type {
...
export const useStockMonitoringStore = defineStore('stock-monitoring', () => {
  ...
  async function fetchParts() {
    ...
    error.value = null
    try {
      const res = await stockMonitoringService.getParts()
  ...
  async function fetchBins() {
    ...
    error.value = null
    try {
      const res = await stockMonitoringService.getBins()
